package br.edu.ifsudestemg.tsi.app;

import br.edu.ifsudestemg.tsi.classes.Tema;
...
/**
 * Programa para gerencia básica de eleições e Simulação de Votação.
 * 
...
public class Aplicacao {
	 ...
	 * @throws InterruptedException caso hava uma interrupção da Thread
	 */
	public static void main(String[] args) throws InterruptedException {
		Thread.sleep(1000);
		Tema.MudarTema("nimbus");
		new Interface();		
	}
